...
const about = () => {
  return (
   <>
      <Head>
         <title>DealerTech | About Page</title>
         <meta name='description' content='about page'/>
      </Head>
      <TransitionEffect />
      <main className='flex w-full flex-col items-center justify-center dark:text-light'>
      <Layout className='pt-16'>
      <AnimatedText text='Best service for your business &#x2713;' 
      className='mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl  sm:mb-8'/>
      <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
         <div className='col-span-3 flex felx-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
            <h2 className='mb-4 text-lg font-bold uppercase text-dark/75 dark:text-light/75'>
               Biography
               <p className='font-medium lowercase dark:text-light'>
            Hi, I'm Usama mohamed, a web developer and designer with a passion for creating beautiful, functional, 
            and user-centered digital experiences. With 3 years of experience in the field. I am always looking for 
            new and innovative ways to bring my clients' visions to life.</p>
            <p className='my-4 font-medium lowercase dark:text-light'>
      ...
      dark:border-light xl:col-span-4 md:order-1 md:col-span-8'>
         ...
         <Image src={profilePic} alt='usama mohamed' className='w-full h-auto rounded-2xl' priority
