  ...
  return (
   ...
   '>
      ...
      <nav className='flex items-center justify-center flex-wrap'>
         <motion.a href='https://www.facebook.com/dealerTechEgypt' target={"_blank"} 
         whileHover={{y:-2}}
         whileTap={{scale:0.9}}
         className='w-6 mx-3'>
         ...
         <motion.a href='https://www.linkedin.com/in/usama-mohamed-679522209/' target={"_blank"} className='w-6 mx-3'
         whileHover={{y:-2}}
         whileTap={{scale:0.9}}>
            <LinkedInIcon />
         </motion.a>
         <motion.a href='https://www.instagram.com/dealertechegypt/'
         whileHover={{y:-2}}
         target={'_blank'}
         whileTap={{scale:0.9}}>
            <InstagramIcon />
         </motion.a>
         <motion.a href='https://www.youtube.com/@usamaharbi' target={"_blank"} className='w-6 mx-3 sm:mx-1'
         whileHover={{y:-2}}
         whileTap={{scale:0.9}}>
            <YoutubeIcon />
         </motion.a>
...

     {
      ...
      <motion.a href='https://www.facebook.com/dealerTechEgypt' target={"_blank"} 
         ...
         <motion.a href='https://www.linkedin.com/in/usama-mohamed-679522209/' target={"_blank"} className='w-6 mx-3 sm:mx-1'
         whileHover={{y:-2}}
         whileTap={{scale:0.9}}>
            <LinkedInIcon />
         </motion.a>
